...
exports.default = Tip;
var _boundingClientRect = _interopRequireDefault(require("bounding-client-rect"));
...
var _componentQuery = _interopRequireDefault(require("component-query"));
...
var html = (0, _domify.default)(_template.default);
...
function tip(elem, options) {
  ...
  var els = typeof elem === 'string' ? _componentQuery.default.all(elem) : [elem];
...
function Tip(content, options) {
  ...
  this.inner = (0, _componentQuery.default)('.tip-inner', this.el);
...
(0, _emitterComponent.default)(Tip.prototype);
...
Tip.prototype.message = function (content) {
  if (typeof content === 'string') content = (0, _domify.default)(content);
...
Tip.prototype.attach = function (el) {
  this.target = el;
  this.handleEvents = (0, _componentEvents.default)(el, this);
...
Tip.prototype.show = function (el) {
  if (typeof el === 'string') el = (0, _componentQuery.default)(el);
  ...
  if (this.options.hideArrow) {
    var tipArrow = (0, _componentQuery.default)('.tip-arrow', this.el);
    if (tipArrow) {
      tipArrow.remove();
    }
  }
  ...
  if (!this.winEvents) {
    this.winEvents = (0, _componentEvents.default)(window, this);
